...
export const items = {
  book: [
    ...
    { name: '', descrption: '', price: '', id: 1, img: '' },
    { name: '', descrption: '', price: '', id: 2, img: '' },
    { name: '', descrption: '', price: '', id: 3, img: '' },
    { name: '', descrption: '', price: '', id: 4, img: '' },
    { name: '', descrption: '', price: '', id: 5, img: '' },
    { name: '', descrption: '', price: '', id: 6, img: '' },
    { name: '', descrption: '', price: '', id: 7, img: '' },
  ],
  mobile: [
    { name: '', descrption: '', price: '', id: uuid(), img: '' },
    { name: '', descrption: '', price: '', id: uuid(), img: '' },
    { name: '', descrption: '', price: '', id: uuid(), img: '' },
    { name: '', descrption: '', price: '', id: uuid(), img: '' },
    { name: '', descrption: '', price: '', id: uuid(), img: '' },
